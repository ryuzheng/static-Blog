...
前段时间趁黑五折扣，买了个小鸡[^1台独立服务器开出来的多台虚拟机，叫作小鸡，更多的可以参考[知乎的VPS黑话大全](https://zhuanlan.zhihu.com/p/23151978)]来玩，由于是什么都没有的centos系统，因此一切装机都要靠自己来，也顺便记录一下自己的心得。

首先，开启一台VPS后，第一步肯定是登录上去，才能进行后续的操作，而我们的VPS平时放在网上，肯定有一堆无聊的人会去扫端口，密码爆破这种无聊的事情[^[详情参考typecho博客遭垃圾评论](https://zhengzexin.com/2019/10/29/fuck_the_spam)]，所以我们第一步是保证服务器的登录安全。
...
使用密钥登录，我们会生成非对称加密[^不清楚非对称加密是什么？看看阮一峰老师的[这篇文章](https://www.ruanyifeng.com/blog/2013/06/rsa_algorithm_part_one.html)]的一对密钥，分别称之为“私钥”和“公钥”。如果公钥加密的信息只有私钥才能解开，那么只要私钥不泄露，通信就是安全的。
